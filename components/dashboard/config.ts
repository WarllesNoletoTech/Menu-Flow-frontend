...
export const dashboardMenus: Record<Role, DashboardItem[]> = {
  SUPER_ADMIN: [
    { icon: '▣', label: 'Visão geral', href: '/admin', userMenu: { order: 1, label: 'Painel administrativo' } }, { icon: '▦', label: 'Estabelecimentos', href: '/admin/restaurantes', userMenu: { order: 2 } }, { icon: '♙', label: 'Usuários', href: '/admin/usuarios', userMenu: { order: 3 } }, { icon: 'R$', label: 'Cobranças', href: '/admin/cobrancas', userMenu: { order: 4 } }, { icon: '♙', label: 'Minha conta', href: '/admin/conta', userMenu: { order: 0 } }, { icon: '↗', label: 'Portal público', href: '/' },
  ],
  RESTAURANT_ADMIN: [{icon:'▣',label:'Visão geral',href:'/empresa',userMenu:{order:1,label:'Painel da loja'}},{icon:'▤',label:'Pedidos',href:'/empresa/pedidos',userMenu:{order:2}},{icon:'☷',label:'Cardápio',href:'/empresa/cardapio',userMenu:{order:3}},{icon:'♙',label:'Funcionários',href:'/empresa/funcionarios',userMenu:{order:4}},{icon:'R$',label:'Faturamento',href:'/empresa/faturamento'},{icon:'⌂',label:'Dados da empresa',href:'/empresa/dados'},{icon:'⚙',label:'Configurações',href:'/empresa/configuracoes',userMenu:{order:5}},{icon:'♙',label:'Minha conta',href:'/empresa/conta',userMenu:{order:0}}],
  EMPLOYEE: [
