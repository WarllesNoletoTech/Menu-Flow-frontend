  ...
  return <header className="mx-auto w-full max-w-7xl lg:mt-4">
    ...
    <div className="px-4 pb-1 pt-12 sm:px-8 sm:pt-14 lg:px-16 lg:pt-20">
      <div className="flex min-w-0 flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-3">
        ...
        <span className={`shrink-0 rounded-full px-3 py-1 text-xs font-black ${restaurant.canAcceptOrdersNow ? 'bg-success/10 text-success' : 'bg-danger/10 text-danger'}`}>{restaurant.canAcceptOrdersNow ? 'ABERTO AGORA' : 'FECHADO PARA PEDIDOS'}</span>
      </div>
