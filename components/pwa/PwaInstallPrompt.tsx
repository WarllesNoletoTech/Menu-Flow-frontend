...
export function PwaInstallPrompt() {
  ...
  if (!canInstall || installed || standalone || hidden || (mode === 'garcom' && !user?.permissions?.includes('TABLES_VIEW')) || pathname.endsWith('/empresa/instalar-app') || pathname.endsWith('/funcionario/instalar-app')) return null;
