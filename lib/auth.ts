...
export type User = { id: string; name: string; email?: string; phone?: string; reportWhatsapp?: string; role: Role; restaurantId?: string; employeePosition?: 'WAITER'|'KITCHEN'|'BAR'|'CASHIER'|'MANAGER'|'OTHER'; permissions?: string[] };
