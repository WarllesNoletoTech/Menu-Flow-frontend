...
export type PublicRestaurant = { _id: string; name: string; slug: string; tradeName?: string; city?: string; state?: string; logoUrl?: string; bannerUrl?: string; description?: string; establishmentType: EstablishmentType; restaurantCategories?: string[]; open: boolean };
